    ...
    <div className="space-y-16">
      ...
      <header className="animate-reveal-up opacity-0" style={{animationFillMode: 'forwards'}}>
        <div className="flex items-center gap-4 mb-6">
          <span className="section-num">Section 05 · Editor&apos;s Desk</span>
          <div className="rule flex-1"></div>
        </div>
        <h1 className="text-huge">
          The <span className="italic font-light text-terracotta">editor&apos;s</span> desk.
        </h1>
        <p className="text-lg font-light text-ink-muted mt-6 max-w-2xl">
          Your final read before anything reaches the press. Nothing publishes without you.
        </p>
      </header>

      {/* Editorial approval workspace */}
      <section className="grid grid-cols-12 gap-0 border-l border-t border-ink/10">
        ...
        <div className="col-span-12 lg:col-span-4 border-r border-b border-ink/10 bg-white">
          <div className="p-6 border-b border-ink/10 bg-ivory-warm">
            <div className="text-eyebrow text-terracotta mb-1">Awaiting review</div>
            <div className="text-3xl font-black">{ideas.length} <span className="text-lg font-light text-ink-muted">drafts</span></div>
          </div>
          ...
          <div className="divide-y divide-ink/10 max-h-[600px] overflow-y-auto">
            {ideas.map((idea, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`text-eyebrow shrink-0 pt-1 ${selected === idea.id ? 'text-terracotta-soft' : 'text-terracotta'}`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className={`text-eyebrow mb-1 ${selected === idea.id ? 'text-terracotta-soft' : 'text-terracotta'}`}>{idea.type}</div>
                    <div className="font-bold text-sm truncate">{idea.title}</div>
            ...
            {ideas.length === 0 && (
              <div className="text-center py-16 text-ink-subtle">
                <div className="text-eyebrow mb-2">All clear</div>
                <div className="text-sm">Every draft has been reviewed.</div>
              </div>
            )}
          </div>
        </div>
        ...
        {selectedIdea ? (
          <div className="col-span-12 lg:col-span-8 border-r border-b border-ink/10 bg-ivory-warm animate-scale-in opacity-0" key={selectedIdea.id} style={{animationFillMode: 'forwards'}}>
            <div className="p-8">
              ...
              <div className="flex items-start justify-between mb-8 pb-6 border-b border-ink/10">
                <div>
                  <div className="text-eyebrow text-terracotta mb-2">Preview № {String(selectedIdea.id).padStart(3, '0')}</div>
                  <h2 className="text-3xl font-black tracking-tight max-w-lg">{selectedIdea.title}</h2>
                </div>
              ...
              <div className="editorial-frame mb-8 max-w-lg mx-auto">
                ...
                <div className="p-4">
                  <div className="text-sm leading-relaxed">
                    ...
                    <span>{selectedIdea.content}</span>
                  </div>
              ...
              <div className="editorial-frame p-6 mb-8 max-w-lg mx-auto" dir="rtl">
                <div className="text-eyebrow text-terracotta mb-3" dir="ltr">Arabic Voice · العربية</div>
              ...
              <div className="grid grid-cols-3 gap-0 border-l border-t border-ink/10 mb-8">
                <div className="p-6 border-r border-b border-ink/10 text-center">
                  ...
                  <div className="text-eyebrow text-ink-subtle mt-2">Engagement</div>
                </div>
                <div className="p-6 border-r border-b border-ink/10 text-center">
                  ...
                  <div className="text-eyebrow text-ink-subtle mt-2">Reach</div>
                </div>
                <div className="p-6 border-r border-b border-ink/10 text-center">
                  ...
                  <div className="text-eyebrow text-ink-subtle mt-2">Best Time</div>
                </div>
              </div>

              {/* Actions - massive, editorial */}
          ...
          <div className="col-span-12 lg:col-span-8 border-r border-b border-ink/10 bg-ivory-warm min-h-[500px] flex items-center justify-center">
            <div className="text-center">
              <div className="text-eyebrow text-ink-subtle mb-2">Editor&apos;s desk</div>
              <div className="text-2xl font-black">All drafts reviewed.</div>
            </div>
          </div>
        )}
      </section>
