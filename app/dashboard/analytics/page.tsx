    ...
    <div className="space-y-16">
      ...
      <header className="animate-reveal-up opacity-0" style={{animationFillMode: 'forwards'}}>
        <div className="flex items-center gap-4 mb-6">
          <span className="section-num">Section 03 · Signal Room</span>
          <div className="rule flex-1"></div>
        </div>
        <h1 className="text-huge">
          The <span className="italic font-light text-terracotta">signal</span> room.
        </h1>
        <p className="text-lg font-light text-ink-muted mt-6 max-w-2xl">
          What&apos;s working. What your audience is asking. What the numbers actually say.
        </p>
      </header>
      ...
      <section className="grid grid-cols-12 border-l border-t border-ink/10 animate-reveal-up opacity-0 delay-200" style={{animationFillMode: 'forwards'}}>
        {[
          { value: mockStats.weeklyReach, label: 'Weekly Reach', trend: '+18%', num: '01' },
          { value: mockStats.weeklyImpressions, label: 'Impressions', trend: '+24%', num: '02' },
          { value: `${mockStats.engagementRate}%`, label: 'Engagement', trend: 'Above avg', num: '03' },
          { value: `+${mockStats.audienceGrowth}%`, label: 'Audience Growth', trend: 'This month', num: '04' },
        ].map((stat, i) => (
      ...
      <section className="animate-reveal-up opacity-0 delay-300" style={{animationFillMode: 'forwards'}}>
        <div className="flex items-baseline justify-between mb-8">
          <div>
            <div className="section-num mb-2">Traffic pattern · Last 30 days</div>
            <h2 className="text-4xl font-black tracking-tight">Engagement, plotted.</h2>
          </div>
      ...
      <section className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-6 animate-reveal-up opacity-0 delay-400" style={{animationFillMode: 'forwards'}}>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="section-num">The Questions</div>
          </div>
          <h2 className="text-3xl font-black tracking-tight mb-6">Your audience wants answers.</h2>

          <div className="editorial-frame divide-y divide-ink/10">
            {mockFAQs.map((faq, i) => (
              <div
                key={i}
                className="p-6 hover:bg-ivory-warm transition-colors group animate-reveal-up opacity-0"
              ...
              >
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="flex-1">
                    ...
                    <div className="font-bold leading-snug">{faq.question}</div>
                    <div className="text-sm text-ink-muted mt-1" dir="rtl">{faq.questionAr}</div>
                  </div>
                  <div className="text-right shrink-0">
                    <div className="text-4xl font-black">{faq.frequency}</div>
                    <div className="text-eyebrow text-ink-subtle">asks</div>
                  </div>
                </div>
                <div className="pt-3 border-t border-ink/10 text-sm text-ink-muted font-light leading-relaxed flex items-start gap-2">
                  ...
                  <span><span className="font-semibold text-ink">Studio suggests:</span> {faq.suggestedContent}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="col-span-12 lg:col-span-6 animate-reveal-up opacity-0 delay-500" style={{animationFillMode: 'forwards'}}>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="section-num">The Hits</div>
          </div>
          <h2 className="text-3xl font-black tracking-tight mb-6">What broke the internet.</h2>

          <div className="space-y-4">
            {mockViralPosts.map((post, i) => (
              <div
                key={post.id}
                className="editorial-frame p-6 hover:bg-ivory-warm transition-colors group animate-reveal-up opacity-0"
